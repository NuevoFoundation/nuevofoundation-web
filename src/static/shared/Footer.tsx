            ...
            <div className="App-footer">
                ...
                <div className="social-images">
                    <a target="_blank" href="https://www.twitter.com/">
                        <FontAwesomeIcon icon={faTwitter} className={"footer-pics fa-2x"} />
                    </a>

                    <a target="_blank" href="http://facebook.com">
                        <FontAwesomeIcon icon={faFacebook} className={"footer-pics fa-2x"} />
                    </a>

                    <a target="_blank" href="https://www.instagram.com/nuevofoundation/">
                        <FontAwesomeIcon icon={faInstagram} className={"footer-pics fa-2x"} />
                    </a>
                    <a target="_blank" href="https://www.linkedin.com/company/nuevofoundation/">
                        <FontAwesomeIcon icon={faLinkedin} className={"footer-pics fa-2x"} />
                    </a>
