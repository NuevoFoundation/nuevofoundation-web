  ...
  public render() {
    return (
      <WhatWeDoWrapper>
        ...
        <LightWrapper>
          <ContentWrapperSmall>
            <div className="bolded-title">
              We Believe that World Change Starts with Educated Children.®
              <br />
              <br />
            </div>
            <div className="default">
              We envision a world in which all children can pursue a quality
              education that enables them to reach their full potential and
              contribute to their communities and the world.
              <br />
              <br />
            </div>
            <div className="default">
              Working in collaboration with local communities, partner
              organizations and governments, we develop literacy skills and a
              habit of reading among primary school children, and support girls
              to complete secondary school with the relevant life skills to
          ...
          <ContentWrapperPadded>
            <div className="left">
              <div className="circle">
                <div className="circle-text">visual element</div>
              </div>
            </div>
            <div className="right">
              <div className="circle">
