  ...
  public collapseSections: any[] = [
    {
      btn: false,
      content:
        "Inspire kids to be curious, confident, and courageous by discovering the world of STEM.",
      open: true,
      title: "MISSION",
      image: MissionImage1,
      iconFill: "#F0000E",
    ...
    },
    {
      ...
      btnContent: "ABOUT US",
      content:
        "Nuevo Foundation is a nonprofit that is run by a group of passionate professionals. We empower underrepresented communities with solutions for future success.",
                ...
                <Col xs={11} xsOffset={1}>
                  <ContentWrapper>
                    <div className="main-title">
                      Inspire your students using coding
                      <br />
